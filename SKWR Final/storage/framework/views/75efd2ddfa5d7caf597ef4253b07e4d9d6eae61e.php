    ...
    <div class="box box-solid">
      ...
      <div class="box-body">
        <table id="example" class="table table-bordered table-striped nowrap" cellspacing="0" width="100%">
          ...
          <tbody>
            <?php $__currentLoopData = $data->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $anggota): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
            <tr>
              <td><?php echo e($anggota->namalengkap); ?></td>
              <td><?php echo e($anggota->nip); ?></td>
              <td><?php echo e($anggota->noanggota); ?></td>
              ...
              <td>
                <button class="show-modal btn btn-success" data-nip="<?php echo e($anggota->nip); ?>"
                  ...
                  data-noanggota="<?php echo e($anggota->noanggota); ?>"
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <br><br>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="namalengkap">Nomor Anggota</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="noanggota_show" disabled>
                    </div>
                </div>
                <br><br>
                <div class="form-group">
...
$(document).ready(function() {
  ...
  $(document).on('click', '.show-modal', function() {
            ...
            $('#noanggota_show').val($(this).data('noanggota'));
