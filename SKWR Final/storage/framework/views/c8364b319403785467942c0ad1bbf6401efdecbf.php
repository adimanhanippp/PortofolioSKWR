    ...
    <body class="body">
        <div class="login-box">
            ...
            <div class="login-box-body">
                ...
                <form action="<?php echo e(url('register/doregister')); ?>" id="form-input" class="form-horizontal">
                ...
                <div class="box-footer">
                  <ul class="pager">
                    <li class="previous"> <a href="<?php echo e(url('/')); ?>">&larr; Back to Login </a> </li>
...
<script type="text/javascript" src="<?php echo e(asset('themes/plugins/jquery/dist/jquery.min.js')); ?>"></script>x
