        ...
        <div class="box box-solid">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a class="btn btn-primary" href="<?php echo e(url('sharing/create')); ?>"><i class="fa fa-plus"></i> New</a>
                </div>
                <?php endif; ?>
            </div>
            <div class="box-body">
                <table id="entah" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>Post at</th>
                            <th>Download</th>
                            <?php if(Entrust::can('sharing_update')): ?>
                            <th>Action</th>
                            <?php endif; ?>
                        </tr>
                    </thead>
...
$(function() {
  ...
  $('#entah').DataTable({
    "processing"      : true,
    "serverSide"      : true,
    "ajax"            : '<?php echo e(url('sharing/ldata')); ?>',
