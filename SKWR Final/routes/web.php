...
Route::group(['prefix' => 'approve'],function(){
  ...
  Route::get('save/{id}',['uses'=> 'registerCtrl@save','middleware'=>'permission:approved']);
  Route::get('delete/{id}',['uses'=> 'registerCtrl@destroy']);
  Route::get('update/{id?}',['uses'=> 'registerCtrl@update','middleware' => 'permission:approved']);
  Route::get('saveupdate', [ 'uses' => 'registerCtrl@saveupdate', 'middleware' => 'permission:approved']);
});
...
Route::group(['prefix' => 'Pengurus' ],function(){
    ...
    Route::get('createperiode/{id?}', [ 'uses' => 'PengurusCtrl@createperiode', 'middleware' => 'permission:pengurus_create' ]);
    Route::get('saveperiode', [ 'uses' => 'PengurusCtrl@saveperiode', 'middleware' => 'permission:pengurus_create' ]);
...
Route::group(['prefix' => 'polling'], function(){
  ...
  Route::post('admin', [ 'uses' => 'PollingCtrl@admin', 'middleware' => 'permission:polling_create' ]);
  Route::get('viewadmin', [ 'uses' => 'PollingCtrl@viewadmin', 'middleware' => 'permission:polling_create' ]);
...
Route::group([ 'prefix' => 'users' ], function() {
    ...
    Route::get('getdata1', [ 'uses' => 'UserCtrl@getdata1', 'middleware' => 'permission:user_index' ]);
});
